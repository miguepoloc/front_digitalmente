                ...
                <div className='d-flex justify-content-center my-4'>
                    <div className="baseintro rounded-3">
                        <header className="baseintro__header rounded-top ">
                            ...
                            <p className="baseintro__para">Es por eso que en esta actividad abordaremos la planeación y organización del tiempo. Para este punto es punto es necesario que identifiques la forma en que distribuyes tu tiempo de forma cotidiana para saber, así como trabajar.</p>
                        </header>
