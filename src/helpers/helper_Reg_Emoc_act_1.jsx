...
export const respuestasCorrectasPorCategoria = (activityIndex, categoria, negrita = true) => {
    let filtrados = seccion2.ejercicios[activityIndex][categoria].filter((opciones) => opciones.isCorrect)
        .map(obj => obj.option.slice(-1) === "." ? obj.option.slice(0, -1) : obj.option) //Quitando el punto final si tiene
...
export const section1 = {
    ...
    activities: [
        ...
        },
        {
            ...
            text: `La tristeza comprende un sentimiento negativo producto de una bajada en el estado de ánimo, acompañada de una reducción de tu actividad en cuanto a pensamientos y acciones. Es una respuesta emocional que te induce a funcionar lentamente a nivel general, buscando ahorrar energía y permitiendo concentrar tu atención en ti, promoviendo la reflexión de situaciones y aspectos que antes podrías haber omitido <hr/> (Fernandez-Abascal <i>et al.</i>, 2010).`,
        },
        {
            name: "Actividad 4",
