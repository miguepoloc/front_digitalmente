        ...
        `
                    ...
                    <div className='row'>
                        ...
                        <div className="col-lg  mb-4 p-2">
                            <div className="card-header  d-flex align-items-center justify-content-center" style={{ background: "#1F3864", minHeight: "69px" }}>
                                <h5 className="my-0 font-weight-normal text-white  text-center" style={{ fontSize: "0.9em" }}>Actividad que se pretende aplazar</h5>
                            </div>
                        ...
                        <div className="col-lg mb-4 p-2">
                            <div className="card-header  d-flex align-items-center justify-content-center" style={{ background: "#1F3864", minHeight: "69px" }}>
                                <h5 className="my-0 font-weight-normal text-white  text-center" style={{ fontSize: "0.9em" }}>Sentimientos que genera su realización</h5>
                            </div>
                            <div className="border shadow  ">
                                <div className="float-left d-flex flex-column">
                        ...
                        <div className="col-lg mb-4 p-2">
                            <div className="card-header  d-flex align-items-center justify-content-center " style={{ background: "#1F3864", minHeight: "69px" }}>
                                <h5 className="my-0 font-weight-normal text-white  text-center" style={{ fontSize: "0.825em" }}>Pensamientos en torno su realización</h5>
                            </div>
                            <div className="border shadow  ">
                                <div className="float-left d-flex flex-column">
                        ...
                        <div className="col-lg mb-4 p-2">
                            <div className="card-header  d-flex align-items-center justify-content-center" style={{ background: "#1F3864", minHeight: "69px" }}>
                                <h5 className="my-0 font-weight-normal text-white  text-center" style={{ fontSize: "0.9em" }}>Comportamiento</h5>
                            </div>
                            <div className="border shadow  ">
                                <div className="float-left d-flex flex-column">
                        ...
                        <div className="col-lg mb-4 p-2">
                            <div className="card-header  d-flex align-items-center justify-content-center " style={{ background: "#1F3864", minHeight: "69px" }}>
                                <h5 className="my-0 font-weight-normal text-white  text-center" style={{ fontSize: "0.9em" }}>Forma de Afrontarlo</h5>
                            </div>
                            <div className="border shadow  ">
                                <div className="float-left d-flex flex-column">
                        ...
                        <div className='text-center'><button className='w-50 search-buttons card-buttons' style={{backgroundColor:"#1F3864"}} onClick={() => handleBtnEnviar()}>Enviar</button></div>
