...
export const DescargablesActFomento = () => {
    return (
        <div className=' text-center'>
            <a href={documentoPdf} download="Autoregistro-Relax.pdf" className='d-flex justify-content-center'>
            ...
            <a href={documentoWord} download="Autoregistro-Relax.docx" className='d-flex justify-content-center'>
            ...
            <a href={documentoExcel} download="Autoregistro-Relax.xlsx" className='d-flex justify-content-center'>
            ...
            <a rel="noreferrer" href="https://docs.google.com/spreadsheets/d/1yRs7zHNwLs3uMggg3H1bpcKRBL9-Ivx1v4Gpje8MpNY/copy?usp=sharing" target={"_blank"} download="Autoregistro-Relax" className='d-flex justify-content-center'>
