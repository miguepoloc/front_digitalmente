                                ...
                                <Accordion.Collapse eventKey="0">
                                    <ul>
                                        ...
                                        <ItemCapsula
                                            ...
                                            link={'/autoevaluativo'}
                                            titulo={'Encuesta'}
                                            habilitado={!(dataAvance.diagnostico >= 1)}
                                            imgsvg={!(dataAvance.diagnostico >= 1)
                                                ? <FaLock />
                                        ...
                                        <ItemCapsula
                                            ...
                                            link={'/resultados'}
                                            titulo={'Resultados'}
                                            habilitado={!(dataAvance.diagnostico >= 2)}
                                            imgsvg={!(dataAvance.diagnostico >= 2)
                                                ? <FaLock />
                                        ...
                                        {linksEmocional.map((capsula, capsulaIndex) => (
                                            <>
                                                <ItemCapsula
                                                    ...
                                                    habilitado={!(dataAvance.emocional >= capsula.id)}
                                                    imgsvg={!(dataAvance.emocional >= capsula.id)
                                                        ? <FaLock />
                                ...
                                <Accordion.Collapse eventKey="2">
                                    <ul>
                                        <ItemCapsula
                                            ...
                                            link={'estrescap1'}
                                            titulo={'Cápsula 1'}
                                            habilitado={!(dataAvance.estres >= 1)}
                                            imgsvg={!(dataAvance.estres >= 1)
                                                ? <FaLock />
                                                : <FaRocket />}
                                        />
                                        ...
                                        <ItemCapsula
                                            ...
                                            link={'/estrescap2'}
                                            titulo={'Cápsula 2'}
                                            habilitado={!(dataAvance.estres >= 2)}
                                            imgsvg={!(dataAvance.estres >= 2)
                                                ? <FaLock />
                                                : <FaRocket />}
                                        />
                                    </ul>
