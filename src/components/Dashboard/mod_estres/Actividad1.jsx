...
export const Actividad1 = () => {
    ...
    return (
        <>
            ...
            <div className='row justify-content-center align-items-center'>
                <div className='col-lg-6'>
                    <Actividad src={imgGanso.meditando} title="¿Para qué me servirá esta actividad?"
                        text={`<br>En muchas ocasiones de nuestra vida podemos llegar a sentirnos abrumados, preocupados e irritados ante las situaciones estresantes que se presentan en el día a día, generando en nosotros sensaciones que hacen difícil buscar soluciones y tener maneras efectivas de superar esos obstáculos, que a lo largo de la vida serán comunes. Puede que surjan en nosotros el querer, tal vez, evitar las obligaciones para no pensar en lo que nos preocupa, o pensar que nunca vamos a poder lograr algo, o que saquemos conclusiones sin mucha evidencia sobre una situación basándonos en lo que creemos que pasará, o que pensemos que somos inútiles. Esta y otras cosas te impiden analizar lo que realmente está pasando alrededor y como son más nuestras acciones poco acertadas lo que nos terminan afectando.`
            ...
            {ActividadCompletada || AvanceState.estres > 2 ? (<>
